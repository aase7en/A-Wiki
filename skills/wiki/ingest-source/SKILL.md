...
> 2026-08-09: consolidated — claude-code/ingest-source (full) merged into wiki/ingest-source (was a pointer). Single canonical copy now at skills/wiki/ingest-source/.
