...
| 3. Script Entry Point Normalization | Done | 2026-05-29 | Replaced Python shims under `scripts/wiki/` with real compatibility wrappers, fixed Windows console encoding for search/review/gen-index chain output, and updated stale gen-index docs from `--dry-run` to `--check`. |
