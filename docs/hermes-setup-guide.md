...
# Tailscale
curl http://100.x.y.z:8501/health
...
| Tailscale | `http://100.x.y.z:8501` | Tailscale on both devices | Medium |
...
- **Tailscale (นอกบ้าน)**: Remote — uses Tailscale IP `100.x.y.z:8501`
