...
|---|---|---|---|---|
| WO-PORTABILITY-BASELINE-20260902 PR48 CI repair | ChatGPT-GPT-5.6-Sol | 2026-09-02 | COLLAB.md; docs/work-orders/WO-PORTABILITY-BASELINE-20260902.md; tests/test_console_pipe_safety.py; tests/test_link_agent_configs.py | fix/wo-portability-primary-integration |
