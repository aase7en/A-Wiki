...
|---|---|---|---|---|
| WO-PORTABILITY-BASELINE-20260902 GPT Primary integration repair | ChatGPT-GPT-5.6-Sol | 2026-09-02 | COLLAB.md; docs/work-orders/WO-PORTABILITY-BASELINE-20260902.md; conductor/__main__.py; scripts/awiki-doctor.py; scripts/awiki-guide.py; scripts/check-graph-yaml.py; scripts/check_pr_loop.py; scripts/hooks/check_machine_path.py; scripts/hospital/verify_regression.py; scripts/mcp-wiki-server.py; tests/test_console_pipe_safety.py; tests/test_link_agent_configs.py; tests/test_link_my_skills.py | fix/wo-portability-primary-integration |
