...
|---|---|---|---|---|
| WO-REVIEW-BRIDGE-20260902 thin conductor review adapter - GPT_REPAIR after exact-SHA review P1/P2 | GPT-5.6 Sol | 2026-09-03 | conductor/review_bridge.py; conductor/cli.py; tests/test_conductor_review_bridge.py; WO; COLLAB | feat/wo-review-bridge-glm-20260902 |
