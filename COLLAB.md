...
| WO-PORTABILITY-BASELINE-20260902 Windows portability baseline burn-down | GLM5.3-ZCode-MAX | 2026-09-02 | COLLAB.md; docs/work-orders/WO-PORTABILITY-BASELINE-20260902.md | fix/wo-portability-baseline-glm-20260902 |
| WO-PORTABILITY-BASELINE-20260902 PB-1 cp874 pipe-safety family | GLM5.3-ZCode-MAX | 2026-09-02 | conductor/__main__.py;conductor/cli.py;scripts/awiki-doctor.py;scripts/awiki-guide.py;scripts/check_pr_loop.py;scripts/hooks/check_machine_path.py;scripts/check-graph-yaml.py;scripts/hospital/verify_regression.py;tests/test_link_agent_configs.py;tests/test_link_my_skills.py;tests/test_console_pipe_safety.py;scripts/mcp-wiki-server.py;tests/test_user_journey_e2e.py | fix/wo-portability-baseline-glm-20260902 |
