...
## 1. เป้าหมาย (Goal)
สร้างระบบ AI Assistant ที่ช่วยให้คุณAase7en (เจ้าของร้านภูฟาร์มาซี) สามารถตรวจสอบรายการสั่งยาที่ลูกน้องส่งมาทาง Line ได้อย่างรวดเร็วและแม่นยำ 100% โดยลดเวลาในการเปิด Catalog กระดาษหรือค้นหาไฟล์ PDF
