---
type: source
title: "[![Compile Examples](https://github.com/arduino-libraries/Arduino_PowerManagemen"
slug: arduino-librariesarduino-powermanagement
date_ingested: 2026-05-24
original_file: raw/arduino-librariesArduino_PowerManagement.md
tags: [iot, arduino]
---
...
> [!note] Note
> These measurements have been taken using a [Nordic Power Profiler Kit II](https://www.nordicsemi.com/Products/Development-hardware/Power-Profiler-Kit-2) through the JST power connector of the Portenta boards, the numbers might be higher when powering through the VIN or 5V pins because it involves more power regulators that are not as efficient as the PF1550's integrated regulators.

## Examples

- [Battery](https://github.com/arduino-libraries/Arduino_PowerManagement/blob/main/examples/Battery/Battery.ino) - Demonstrates battery metrics monitoring.
- [Charger](https://github.com/arduino-libraries/Arduino_PowerManagement/blob/main/examples/Charger/Charger.ino) - Illustrates charger status monitoring and control.
- [Standby\_WakeFromPin](https://github.com/arduino-libraries/Arduino_PowerManagement/blob/main/examples/Standby_WakeFromPin/Standby_WakeFromPin.ino) - Demonstrates how to wake up the board from standby using a wakeup pin.
- [Standby\_WakeFromRTC\_C33](https://github.com/arduino-libraries/Arduino_PowerManagement/blob/main/examples/Standby_WakeFromRTC_C33/Standby_WakeFromRTC_C33.ino) - Demonstrates how to use the RTC to wake the Portenta C33 from standby.
- [Standby\_WakeFromRTC\_H7](https://github.com/arduino-libraries/Arduino_PowerManagement/blob/main/examples/Standby_WakeFromRTC_H7/Standby_WakeFromRTC_H7.ino) - Demonstrates how to use the RTC to wake the Portenta H7 from standby.
...
3. Check out the examples or read the documentation [here](https://github.com/arduino-libraries/Arduino_PowerManagement/blob/main/docs).
