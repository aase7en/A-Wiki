---
type: source
title: "[![](https://github.com/ropg/heltec_esp32_lora_v3/raw/main/images/ESP32_LoRa_v3"
slug: ropgheltec-esp32-lora-v3-proper-working-arduino-library-for
...
[![](https://github.com/ropg/heltec_esp32_lora_v3/raw/main/images/ESP32_LoRa_v3.png)](https://github.com/ropg/heltec_esp32_lora_v3/blob/main/images/ESP32_LoRa_v3.png)
...
<table><tbody><tr><td colspan="3" align="center"><p><strong>ESP32-S3</strong> processor<br><sup><em>( 2.4 GHz WiFi, BT 5 LE, 512 MB SRAM )</em></sup><br><strong>8 MB</strong> SPI flash<br>USB-C, <strong>CP2102</strong> USB serial chip<br>Semtech <strong>SX1262</strong> sub-GHz transceiver<br>3.7V LiPo battery charging circuit</p></td></tr><tr><td width="300px" align="center"><p><a href="https://github.com/ropg/heltec_esp32_lora_v3/blob/main/images/regular_board_mini_img.png"><img src="https://github.com/ropg/heltec_esp32_lora_v3/raw/main/images/regular_board_mini_img.png"></a></p></td><td width="300px" align="center"><p><a href="https://github.com/ropg/heltec_esp32_lora_v3/blob/main/images/stick_lite_mini_img.png"><img src="https://github.com/ropg/heltec_esp32_lora_v3/raw/main/images/stick_lite_mini_img.png"></a></p></td><td width="300px" align="center"><p><a href="https://github.com/ropg/heltec_esp32_lora_v3/blob/main/images/lite_mini_img.png"><img src="https://github.com/ropg/heltec_esp32_lora_v3/raw/main/images/lite_mini_img.png"></a></p></td></tr><tr><td align="center"><p><strong>WiFi LoRa 32(V3)</strong> a.k.a.<br><strong>HTIT-WB32LA</strong> a.k.a.<br><strong>ESP32 LoRa v3</strong></p></td><td align="center"><p><strong>Wireless Stick(V3)</strong> a.k.a.<br><strong>HTIT-WS_V3</strong></p></td><td align="center"><p><strong>Wireless Stick Lite(V3)</strong><br>a.k.a. <strong>HTIT-WSL_V3</strong></p></td></tr><tr><td align="center"><p><strong>128 x 64 OLED</strong></p></td><td align="center"><p><strong>64 x 32 OLED</strong></p></td><td align="center"><p>no display</p></td></tr><tr><td align="center"><p>No RF shielding</p></td><td align="center" colspan="2"><p>Metal shielding</p></td></tr><tr><td align="center" colspan="2"><p>Built-in Wifi antenna<br>LoRa antenna connector IPEX1.0</p></td><td align="center"><p>Built-in Wifi antenna<br>WiFi ant. conn. IPEX1.0 (right)<br>LoRa ant. conn. IPEX1.0 (left)</p></td></tr><tr><td align="center"><b>147 µA</b> (button wakes)<br><b>24 µA</b> (clock wakes)</td><td align="center"><b>141 µA</b> (button wakes)<br><b>24 µA</b> (clock wakes)</td><td align="center"><b>130 µA</b> (button wakes)<br><b>17 µA</b> (clock wakes)</td></tr></tbody></table>
...
[![](https://github.com/ropg/heltec_esp32_lora_v3/raw/main/images/board_manager_url.png)](https://github.com/ropg/heltec_esp32_lora_v3/blob/main/images/board_manager_url.png)
...
> - *If you `#define HELTEC_NO_RADIO_INSTANCE` and/or `#define HELTEC_NO_DISPLAY_INSTANCE` before `#include <heltec_unofficial.h>`, you get no instances of `radio` and/or `display`, so you can set these up manually. Note that the library then also doesn't turn things off at sleep, etc.*
...
> - *If you place `#define HELTEC_NO_RADIOLIB` before `#include <heltec_unofficial.h>`, RadioLib will not be included and this library won't create a radio object. Handy if you are not using the radio and need the space in flash for something else or if you want to use another radio library or so.*
...
[![](https://github.com/ropg/heltec_esp32_lora_v3/raw/main/images/battery-connector.jpg)](https://github.com/ropg/heltec_esp32_lora_v3/blob/main/images/battery-connector.jpg)
...
[![](https://github.com/ropg/heltec_esp32_lora_v3/raw/main/images/battery_curve.png)](https://github.com/ropg/heltec_esp32_lora_v3/blob/main/images/battery_curve.png)
...
[![](https://github.com/ropg/heltec_esp32_lora_v3/raw/main/images/heltec_esp32_lora_v3_pinout.png)](https://github.com/ropg/heltec_esp32_lora_v3/blob/main/images/heltec_esp32_lora_v3_pinout.png)

[![](https://github.com/ropg/heltec_esp32_lora_v3/raw/main/images/heltec_esp32_lora_v3_schematic.png)](https://github.com/ropg/heltec_esp32_lora_v3/blob/main/images/heltec_esp32_lora_v3_schematic.pdf)

### Heltec Wireless Stick v3 / HTIT-WS\_v3 / "the stick"

[![](https://github.com/ropg/heltec_esp32_lora_v3/raw/main/images/Heltec_Wireless_Stick_v3_pinout.jpg)](https://github.com/ropg/heltec_esp32_lora_v3/blob/main/images/Heltec_Wireless_Stick_v3_pinout.jpg)

[![](https://github.com/ropg/heltec_esp32_lora_v3/raw/main/images/Heltec_Wireless_Stick_v3_schematic.png)](https://github.com/ropg/heltec_esp32_lora_v3/blob/main/images/Heltec_Wireless_Stick_v3_schematic.pdf)

### Heltec Wireless Stick Lite v3 / HTIT-WSL\_v3 / "the stick lite"

[![](https://github.com/ropg/heltec_esp32_lora_v3/raw/main/images/Heltec_Wireless_Stick_Lite_v3_pinout.png)](https://github.com/ropg/heltec_esp32_lora_v3/blob/main/images/Heltec_Wireless_Stick_Lite_v3_pinout.png)

[![](https://github.com/ropg/heltec_esp32_lora_v3/raw/main/images/Heltec_Wireless_Stick_Lite_v3_schematic.png)](https://github.com/ropg/heltec_esp32_lora_v3/blob/main/images/Heltec_Wireless_Stick_Lite_v3_schematic.pdf)
