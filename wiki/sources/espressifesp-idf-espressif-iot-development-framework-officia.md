---
type: source
title: "- [中文版](https://github.com/espressif/esp-idf/blob/master/README_CN.md)"
slug: espressifesp-idf-espressif-iot-development-framework-officia
...
See [https://idf.espressif.com/](https://idf.espressif.com/) for links to detailed instructions on how to set up the ESP-IDF depending on chip you use.
...
As well as the [esp-idf-template](https://github.com/espressif/esp-idf-template) project mentioned in Getting Started, ESP-IDF comes with some example projects in the [examples](https://github.com/espressif/esp-idf/blob/master/examples) directory.
...
- Documentation for the latest version: [https://docs.espressif.com/projects/esp-idf/](https://docs.espressif.com/projects/esp-idf/). This documentation is built from the [docs directory](https://github.com/espressif/esp-idf/blob/master/docs) of this repository.
