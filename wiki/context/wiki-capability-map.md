...
| High-end lightweight game | Phaser game + PixelLab pipeline live in the product repo (moved 2026-07-12). | Game lane locks performance budget, asset manifest validation, and no-secret runtime rules. | `python3 scripts/game/report_phaser_asset_pack.py game-assets/manifests --root . --check-files (run in product repo)` |
...
| Title | Family | Path |
|---|---|---|
| G3 — MCP stdio compatibility port spec | docs/protocols | `docs/protocols/adr-0012-g3-mcp-compat-port-spec.md` |
...
| Cross-Agent Security Hooks Protocol (USA-1 §5.2) | docs/protocols | `docs/protocols/cross-agent-security-hooks.md` |
| Cross-Agent Work Orders — มาตรฐานบังคับ (binding) สำหรับทุก agent ทุก repo | docs/protocols | `docs/protocols/cross-agent-work-orders.md` |
| Cross-Device Sync Protocol — Hermes Pi5 ↔ Mac ↔ Windows PC | docs/protocols | `docs/protocols/cross-device-sync.md` |
...
| Neural Spine — Cross-Session Memory + Multi-Agent Coordination | docs/protocols | `docs/protocols/neural-spine.md` |
| NotebookLM-first Protocol | docs/protocols | `docs/protocols/notebooklm.md` |
| Plugin Generator Spec — adding a new agent to A-Wiki's skill system | docs/protocols | `docs/protocols/plugin-generator-spec.md` |
...
| Secrets storage — global universal .env in Google Drive | docs/protocols | `docs/protocols/secrets-global-env.md` |
...
| Smoke Test — Pi5 / Hermes Telegram + A-Med-Order | docs/runbooks | `docs/runbooks/pi5-smoke-test-a-med-order.md` |
