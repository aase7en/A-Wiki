...
| Agent Continuity Gate — กฎเข้า-ออก-ส่งต่อ สำหรับทุก agent ใน repo นี้ | docs/protocols | `docs/protocols/agent-continuity-gate.md` |
...
| Defect Memory — บันไดป้องกันการเกิดซ้ำ (Executable > Prose) | docs/protocols | `docs/protocols/defect-memory.md` |
...
| Prompt Placement Header — Universal Cross-Agent Protocol | docs/protocols | `docs/protocols/prompt-placement-protocol.md` |
...
| Review Bus — Operator Runbook (Phases 8–9) | docs/runbooks | `docs/runbooks/review-bus.md` |
