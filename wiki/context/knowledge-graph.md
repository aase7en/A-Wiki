...
_Generated: 2026-08-20_  •  _Source: `.wiki-graph.json` (regen by `scripts/gen-index.py`)_

## Stats

- **Nodes**: 550
- **Edges**: 1839
- **Broken links**: 40 (run `python3 scripts/query-graph.py --broken`)
- **Orphans**: 28 (run `python3 scripts/query-graph.py --orphans`)
