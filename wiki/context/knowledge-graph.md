...
_Generated: 2026-05-30_  •  _Source: `.wiki-graph.json` (regen by `scripts/gen-index.py`)_

## Stats

- **Nodes**: 458
- **Edges**: 1150
- **Broken links**: 66 (run `python3 scripts/query-graph.py --broken`)
- **Orphans**: 194 (run `python3 scripts/query-graph.py --orphans`)
