...
_Generated: 2026-07-31_  •  _Source: `.wiki-graph.json` (regen by `scripts/gen-index.py`)_

## Stats

- **Nodes**: 548
- **Edges**: 1832
- **Broken links**: 38 (run `python3 scripts/query-graph.py --broken`)
- **Orphans**: 30 (run `python3 scripts/query-graph.py --orphans`)
