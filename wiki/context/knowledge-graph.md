...
_Generated: 2026-07-13_  •  _Source: `.wiki-graph.json` (regen by `scripts/gen-index.py`)_

## Stats

- **Nodes**: 542
- **Edges**: 1779
- **Broken links**: 11 (run `python3 scripts/query-graph.py --broken`)
- **Orphans**: 16 (run `python3 scripts/query-graph.py --orphans`)
