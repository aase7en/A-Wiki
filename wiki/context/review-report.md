...
- wiki/entities/ai-tools/trello-mcp.md: missing frontmatter key: title
...
- wiki/entities/env/building.md: missing frontmatter key: title
- wiki/entities/env/chemical.md: missing frontmatter key: title
- wiki/entities/env/env-webapp-project.md: missing frontmatter key: title
- wiki/entities/env/fire-safety.md: missing frontmatter key: title
- wiki/entities/env/food.md: missing frontmatter key: title
- wiki/entities/env/fuel.md: missing frontmatter key: title
- wiki/entities/env/garbage.md: missing frontmatter key: title
- wiki/entities/env/garden.md: missing frontmatter key: title
- wiki/entities/env/rabies-pep-surveillance.md: missing frontmatter key: title
- wiki/entities/env/water-supply.md: missing frontmatter key: title
...
- wiki/entities/ai-tools/trello-mcp.md: missing TL;DR line
...
- wiki/entities/env/building.md: missing TL;DR line
- wiki/entities/env/chemical.md: missing TL;DR line
- wiki/entities/env/env-webapp-project.md: missing TL;DR line
- wiki/entities/env/fire-safety.md: missing TL;DR line
- wiki/entities/env/food.md: missing TL;DR line
- wiki/entities/env/fuel.md: missing TL;DR line
- wiki/entities/env/garbage.md: missing TL;DR line
- wiki/entities/env/garden.md: missing TL;DR line
- wiki/entities/env/rabies-pep-surveillance.md: missing TL;DR line
- wiki/entities/env/water-supply.md: missing TL;DR line
