...
> Last updated: 2026-06-20  |  Run: `python3 scripts/gen-index.py`
...
| AI Tools | 21 | 32 | `wiki/context/overview-ai.md` | `index-ai.md` |
| Pharmacy | 5 | 8 | `wiki/context/overview-pharmacy.md` | `index-pharmacy.md` |

- **Sources** (165): `wiki/context/overview-sources.md`
...
*Slim baseline. Detailed entries split across 5 domain files. Total 491 pages across 4 sections.*
