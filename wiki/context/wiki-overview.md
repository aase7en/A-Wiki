...
> Last updated: 2026-09-16  |  Run: `python3 scripts/gen-index.py`
...
|--------|----------|----------|--------------|------------|
| IoT | 37 | 12 | `wiki/context/overview-iot.md` | `index-iot.md` |
| Environmental Health | 12 | 5 | `wiki/context/overview-env.md` | `index-env.md` |
| AI Tools | 38 | 33 | `wiki/context/overview-ai.md` | `index-ai.md` |
...
- **Sources** (177): `wiki/context/overview-sources.md`
...
| `air-quality-monitoring` | ใช้ [[entities/iot/pms5003]] วัด PM2.5/PM10 ต่อกับ… |
| `appsheet-to-webapp-pi5` | "จะสร้าง web application ทดแทน AppSheet (ActivatedSludge + Epide… |
| `claude-skills-gap-web-game-2026` | จากโพสต์ [[sources/charliejhills-claude-skills-org-chart-2026]]… |
...
| `electricity-monitor-hospital` | ใช้ **[[entities/iot/sct-013]] (non-invasive CT clamp)** + **… |
| `energy-power-monitoring` | ใช้ [[entities/iot/pzem-004t]] ต่อกับ [[entities/iot/esp32]] ผ่า… |
| `env-webapp-schema-v2-multi-domain` | Supabase-first (no FastAPI in production, ADR-0004). |
...
| `pharmacy-project-specs` | สร้างระบบ AI Assistant ที่ช่วยให้คุณ Aase7en (เจ้าของร้านภูฟาร์ม… |
...
| `synth-00-agent-entry` | _To be filled in by human review._ |
| `synth-10-ssot-continuity` | _To be filled in by human review._ |
| `synth-20-engineering-main-flow` | _To be filled in by human review._ |
| `synth-21-shaping-research` | _To be filled in by human review._ |
| `synth-3-dashboard-node-red` | (awaiting human summary) |
| `synth-30-repo-safety` | Any repository mutation, branch/commit/worktree operation, destr… |
| `synth-40-verification-debug` | _To be filled in by human review._ |
| `synth-41-e2e-audit` | _To be filled in by human review._ |
| `synth-42-defect-memory` | A material defect, recurring failure, incident, or important deb… |
| `synth-50-release` | Committing, opening/reviewing a PR, waiting on CI/CD, merging, o… |
| `synth-60-delegation` | Work is being handed to another agent, worker, model, vendor, Co… |
| `synth-80-upstream-references` | This template incorporates methodology inspired by the AIHero /… |
| `synth-90-master-spec` | _To be filled in by human review._ |
...
| `synth-ai-engineering-agent-patterns` | _To be filled in by human review._ |
...
| `synth-akashdeepo-monte-carlo-rrr` | _To be filled in by human review._ |
...
| `synth-charliejhills-claude-skills-org-chart-2026` | _To be filled in by human review._ |
| `synth-chart-images-from-url` | (awaiting human summary) |
| `synth-claude-model-cost-switching-strategy-2026-06` | _To be filled in by human review._ |
| `synth-cloudflare-tunnel-pi5` | (awaiting human summary) |
...
| `synth-deepseek-aideepseek-v4-pro-at-main` | (awaiting human summary) |
...
| `synth-hermes-agent-readme` | (awaiting human summary) |
| `synth-heston-model-wikipedia` | Source: https://en.wikipedia.org/wiki/Heston_model Fetched: 2026… |
...
| `synth-merton-jump-diffusion` | _To be filled in by human review._ |
| `synth-merton-jump-diffusion-wikipedia` | Source: https://en.wikipedia.org/wiki/Jump_diffusion Fetched: 20… |
| `synth-mqtt-introduction` | _To be filled in by human review._ |
| `synth-muratcankoyyan-context-eng-ref` | A comprehensive, open collection of Agent Skills focused on cont… |
...
| `synth-pake-github` | _To be filled in by human review._ |
...
| `synth-prat011-llm-skills-ref` | Detailed description of the skill's purpose and capabilities. -… |
...
| `synth-thai-tax-deduction-document-guide` | _(Extract from source sections)_ |
...
| `synth-universal-autonomous-project-architect-loop-engineer-prompt` | Use this prompt to bootstrap, architect, document, plan, impleme… |
...
| `waste-weight-monitoring` | ใช้ [[entities/iot/load-cell]] (strain gauge) +… |
| `wiki-to-video-pipeline` | จะใช้ [[entities/ai-tools/hyperframes]] ร่วมกับ InW-Wiki และ Hyp… |

---

*Slim baseline. Detailed entries split across 5 domain files. Total 544 pages across 4 sections.*
